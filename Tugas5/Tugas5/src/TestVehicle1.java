public class TestVehicle1 {
    public static void main(String[] args) {
        System.out.println("Creating a vehicle a 10,000 kg maximumload.");
        ...
        System.out.println("Add load(100kg) : " + (vehicle.load=500)); // no 2 dan 3
        ...
        System.out.println("Add load(100kg) : " + (vehicle.load=500)); // no 3
    }
}
